 ...
 -->
	...
	<div class="w3-col m6 w3-center">
		...
		<div class="w3-col w3-padding w3-margin-bottom">
			<form id="frm" class="w3-col w3-card" method="POST" action="/www/board/writeProc.van" enctype="multipart/form-data">
				<input type="hidden" id="id" name="bid" value="${SID}" >
				<div class="w3-row">
				...
				<div class="w3-row w3-margin-top">
					...
					<div class="w3-col m10 w3-padding">
						<input class="w3-input w3-border" type="file" id="file" name="sFile"
																		placeholder="# 파일 선택!">
					</div>
				</div>
			...
			<div class="w3-col w3-margin-top">
				...
				<input class="w3-button w3-small w3-blue w3-hover-amber w3-left" type="submit" value="게시하기">
			</div>
		</form>
		</div>
	</div>
